...
import static ru.itmo.ctddev.kopitsa.test.FunctionalExpressionTest.POLISH;
...
public class ObjectExpressionTest extends BaseJavascriptTest<JSEngine> {
    ...
    protected ObjectExpressionTest(final int mode, final Language language) {
        super(new JSEngine("ru/itmo/ctddev/kopitsa/objectExpression.js", ".evaluate"), language, mode >= 1);
        testSimplify = mode >= 2;
    }
