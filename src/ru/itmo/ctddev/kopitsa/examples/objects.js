...
shiftedPoint.dx = 1;
shiftedPoint.dy = 2;
shiftedPoint.getX = function () {
    return shiftedPoint.x + shiftedPoint.dx;
};
shiftedPoint.getY = function () {
    return shiftedPoint.y + shiftedPoint.dy;
};
...
PointWithPrototype.prototype.getX = function () {
    return this.x;
};
PointWithPrototype.prototype.getY = function () {
    return this.y;
};
